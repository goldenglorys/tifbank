	...
	<div class="row">
		<div class="col-md-12">
          ...
          <div class="card">
          	...
          	<div class="card-body">
          		<form action="getmytransfer.php" method="post">
               <div>From: 
                 <select class="form-control" name="type1">
                   <option>Transfer From your</option>
                    <option value="Savings Acct">Savings Account</option>
                     <option value="Checking Acct">Checking Account</option>
                 </select>
               </div><br>
               <div>To: 
                 <select class="form-control" name="type2">
                   <option>Transfer To your</option>
                    <option value="Savings Acct">Savings Acct</option>
                     <option value="Checking Acct">Checking Acct</option>
                 </select>
               </div>
