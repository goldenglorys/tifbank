    ...
    <div class="row">
      <div class="col-md-12">
         <nav class="fixed-top navbar" style="height:80px;background-color:#85BEED;"> 
          ...
          <div class="card">
              <div class="card-header text-center"><h3 class="text-success">Citizens Bank Deposit Page</h3></div>
              <div class="card-body">
              <div class="text-center"></div>
              <form action="getdeposit.php" method="post">
              ...
              <div>Depositor's Name: <input type="text" name="depositor" class="form-control" placeholder="Depositor's name"></div>
...
<!--               <div>Date: <input type="date" name="date" class="form-control"></div>
 -->              <div class="text-center"><input type="submit" name="" value="Deposit" class="btn btn-success mt-3"></div>
              </form>
              </div>
          </div>
          </div> 
